# Storyworld Provider Adapter Failure Cases
...
- Prohibited action attempted: Provider direct write to assets/canon/approval
- Prohibited action attempted: Silent model or route substitution
- Prohibited action attempted: Browser-exposed provider secrets
- Prohibited action attempted: Permanent provider URLs
- Prohibited action attempted: Automatic fallback for prohibited profiles
