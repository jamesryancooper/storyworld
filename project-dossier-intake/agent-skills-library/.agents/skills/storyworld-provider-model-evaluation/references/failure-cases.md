# Storyworld Provider Model Evaluation Failure Cases
...
- Prohibited action attempted: Silent production promotion
- Prohibited action attempted: Using private/restricted fixtures on disallowed routes
- Prohibited action attempted: Hiding model/provider actually used
- Prohibited action attempted: Approving based solely on vendor claims
