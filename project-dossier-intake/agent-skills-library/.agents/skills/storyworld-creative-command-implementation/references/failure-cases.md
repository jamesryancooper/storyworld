# Storyworld Creative Command Implementation Failure Cases
...
- Prohibited action attempted: Executing raw model tool calls without Storyworld validation
- Prohibited action attempted: Applying medium/high-consequence operations before required confirmation
- Prohibited action attempted: Letting a provider choose authority, acceptance, or publication state
