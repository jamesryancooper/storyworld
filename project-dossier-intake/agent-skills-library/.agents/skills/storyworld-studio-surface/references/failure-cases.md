# Storyworld Studio Surface Failure Cases
...
- Prohibited action attempted: Direct imports from persistence/kernel private packages into Studio
- Prohibited action attempted: Color-only state communication
- Prohibited action attempted: Hidden consequences
- Prohibited action attempted: AI theater that conceals operations or limitations
