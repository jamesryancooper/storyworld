# Storyworld Runtime Adapter Failure Cases
...
- Prohibited action attempted: Automatic canon mutation
- Prohibited action attempted: Runtime state as Storyworld source truth
- Prohibited action attempted: Duplicated browser/Godot narrative models
- Prohibited action attempted: Package acceptance inferred from build success
