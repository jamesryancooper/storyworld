# Storyworld Creative Direction Failure Cases
...
- Prohibited action attempted: One everything-object for all creative departments
- Prohibited action attempted: One universal property-to-shot inheritance chain
- Prohibited action attempted: Named artist prompts as canonical style definitions
- Prohibited action attempted: Automatic emotion-to-color/lens/music rules
