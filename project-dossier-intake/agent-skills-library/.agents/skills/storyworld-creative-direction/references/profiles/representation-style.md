# Representation Style Profile

**Parent skill:** `storyworld-creative-direction`  
**Status:** implementation guidance; noncanonical and unadopted.

## Purpose

Narrow representation style to medium, mark-making, form, texture, abstraction, modeling, shading, spatial depiction, and motion treatment; keep scene mood, lighting, composition, and grade in their own systems.
