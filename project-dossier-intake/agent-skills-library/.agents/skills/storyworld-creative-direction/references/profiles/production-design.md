...
Separate canonical place/object from production realization, set/location design, dressing, props, spatial layout, constraints, and continuity state.
