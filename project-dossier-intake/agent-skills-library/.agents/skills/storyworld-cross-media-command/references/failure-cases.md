# Storyworld Cross Media Command Failure Cases
...
- Prohibited action attempted: Expanding the active task's authority
- Prohibited action attempted: Treating staged dossier material or this skill as an accepted decision
- Prohibited action attempted: Claiming implementation, validation, readiness, approval, or external success without direct evidence
- Prohibited action attempted: Using credentials, spending money, publishing, deploying, or contacting external systems without explicit current authorization
