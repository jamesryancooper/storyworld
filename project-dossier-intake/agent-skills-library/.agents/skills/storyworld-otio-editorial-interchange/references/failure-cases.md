# Storyworld OTIO Editorial Interchange Failure Cases
...
- Prohibited action attempted: Silent import overwrite
- Prohibited action attempted: Pretending round trip is lossless
- Prohibited action attempted: Using editor-internal clip IDs as Storyworld identity
- Prohibited action attempted: Dropping unsupported effects without a finding
