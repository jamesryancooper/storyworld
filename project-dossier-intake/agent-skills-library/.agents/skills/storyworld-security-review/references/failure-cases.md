# Storyworld Security Review Failure Cases
...
- Prohibited action attempted: Using live secrets for review without authorization
- Prohibited action attempted: Publishing exploit instructions against production targets
- Prohibited action attempted: Approving own security blockers
- Prohibited action attempted: Treating dependency popularity as assurance
