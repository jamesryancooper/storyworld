---
name: storyworld-poc-execution
description: Execute a disposable Storyworld proof of concept that answers one risky architectural question and ends in an explicit adoption decision.
---
...
Reduce uncertainty without allowing prototype code, private formats, or successful demos to become production architecture automatically.

## Use this skill when

- The integration architecture POC program identifies a high-risk interface, dependency, workflow, or UX question
- A dependency must prove replacement, security, accessibility, or fidelity before adoption

## Do not use this skill when

- The governing decision already chose the production implementation and the task is ordinary implementation
- No teardown or success criteria exist
...
1. Confirm the POC is authorized and disposable
2. Define the Storyworld-owned semantic layer before selecting dependencies
3. Pin dependency versions, licenses, transitive packages, credentials, and external costs
4. Build the smallest prototype with valid and intentional failure cases
5. Run accessibility, security, privacy, performance, portability, replacement, and recovery checks
6. Compare results to explicit success criteria
7. Produce adopt, adapt, defer, reject, or repeat recommendation
8. Tear down prototype code unless separately promoted through a governed task

## Required invariants

- POC success does not adopt a dependency
- Production data and credentials are prohibited unless separately authorized
- Prototype code is not production code by default
- Decision evidence survives teardown
