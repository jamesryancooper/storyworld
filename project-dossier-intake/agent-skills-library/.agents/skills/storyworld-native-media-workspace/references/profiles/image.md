...
**Parent skill:** `storyworld-native-media-workspace`  
**Status:** implementation guidance; noncanonical and unadopted.

## Purpose

Native image generation/editing: variants, subject/object/background changes, appearance, relighting, reframing, canvas extension, identity/composition preservation, text repair, isolation, upscale, restoration, and multi-source composition.
