# Storyworld Comfyui Workflow Failure Cases
...
- Prohibited action attempted: Unpinned custom nodes
- Prohibited action attempted: Arbitrary network egress
- Prohibited action attempted: Storyworld database credentials in ComfyUI
- Prohibited action attempted: Automatic production promotion
- Prohibited action attempted: Routine user dependency on the graph UI
