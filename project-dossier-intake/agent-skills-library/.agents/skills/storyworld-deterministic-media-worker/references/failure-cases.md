# Storyworld Deterministic Media Worker Failure Cases
...
- Prohibited action attempted: Shelling arbitrary user commands
- Prohibited action attempted: Unbounded decompression
- Prohibited action attempted: Network fetch by media parser
- Prohibited action attempted: Secrets or database access
- Prohibited action attempted: Treating successful encode as creative approval
