# Storyworld Asset Custody And Lineage Failure Cases
...
- Prohibited action attempted: Direct overwrite of accepted assets
- Prohibited action attempted: Promotion without exact-version human authority
- Prohibited action attempted: Deleting required evidence
- Prohibited action attempted: Cross-tenant physical deduplication leaking semantic access
