# Storyworld Conformance And Release Failure Cases
...
- Prohibited action attempted: Accepting decisions or gates
- Prohibited action attempted: Claiming CI or tests ran when only repository prose says so
- Prohibited action attempted: Hiding dirty state or skipped validation
